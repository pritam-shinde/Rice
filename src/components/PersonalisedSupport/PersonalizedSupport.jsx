...
// import React from 'react';
// import Img1 from "../../../public/images/img1.jpg";
// // import styles from './PersonalizedSupport.module.css';

// const PersonalizedSupport = () => {
//   return (
//     <>
//       <Container maxWidth="xxl" className="border m-2 mx-auto cardContainer">
//         <Grid container spacing={2}>
//           <Grid item xs={12}  md={10} className='mx-auto' mt={2}>
//             <Typography variant="h3" align="center" py={1}>
//               Personalized Support
//             </Typography>
//           {/* <section className='d-flex  mx-auto' style={{background:"grey"}}>
//           <Grid item xs={12} sm={6} md={4}>
//             <Box m={2}>
//               <Card className="card">
//                 <Image src={Img1} alt="card1-img" className="mx-auto" height={100} />
//                 <CardContent>
//                   <Typography variant="h5">Design Stage</Typography>
...
//             <Box m={2}>
//               <Card className="card">
//                 <Image src={Img1} alt="card2-img" className="mx-auto" height={100} />
//                 <CardContent>
//                   <Typography variant="h5">Energy Study</Typography>
//                   <Typography variant="body2" color="text.secondary">
...
//             <Box m={2}>
//               <Card className="card">
//                 <Image src={Img1} alt="card3-img" className="mx-auto" height={100} />
//                 <CardContent>
//                   <Typography variant="h5">Technical Services</Typography>
//                   <Typography variant="body2" color="text.secondary">
//                   Facade integration, full system design, installation supervision, commisioning and monitoring.
//                   </Typography>
//                 </CardContent>
//               </Card>
//             </Box>
    ...
    <div className="card-container">
      <Box className="card">
        <div className="card-content">
          <Image src={Img1} alt="card1-img" className="card-image" />
        ...
        <Grid container spacing={6}>
          ...
          <Grid item xs={12} md={6}>
            <Box>
              ...
              <Box mb={3}>
                <Typography variant="h4">Drawing & Mapping</Typography>
                <Typography variant="para">Drawing and 3D modeling tools are used to conduct a complete solar study.</Typography>
              </Box>
              <Box mb={3}>
                <Typography variant="h4">Data Analysis</Typography>
                <Typography variant="para">Reports are produced detailing how much energy will be generated and saved, and what the impact will be on occupant comfort.</Typography>
